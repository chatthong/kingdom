...
- **The 43 rules:** `.kingdom/.setting/rules.md`. Tier 1 = iron-clad (10, capped — see v0.31.0 legend); Tier 2 = strong defaults (28); Tier 3 = conventions (5).
