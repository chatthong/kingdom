...
```
.claude-plugin/
  plugin.json              # name=kingdom, version=0.38.0
...
commands/                  # 5 slash commands
  ...
  self-care.md             # prereq checker (Check 12 = version-drift detection)
...
.kingdom/.setting/         # canonical source — copied into workspace by /kingdom:init
  ...
  rules/                   # one rule per file (R01..R51) + index.md registry (Tier 1/2/3; Tier-1 capped at 10) — v0.34.0
  ...
  manifest.json            # feature registry (core/cmux/browser/senior/watchman) for load_feature — v0.35.0/v0.36.0
  ...
  cards/                   # 25 display templates + README
...
- **The 51 rules:** `.kingdom/.setting/rules/` (one per file + `index.md` registry). Tier 1 = iron-clad (10, capped — see legend); Tier 2 = strong defaults (36); Tier 3 = conventions (5).
