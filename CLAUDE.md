...
.kingdom/.setting/         # canonical source — copied into workspace by /kingdom:init
  ...
  functions/               # one bash helper per file + index.md + _load.sh (subfolder-aware) — v0.34.0
    cmux/                  # the cmux.app backend: 22 cmux_* wrappers + 8 browser_* (one per subcommand) — v0.36.0
