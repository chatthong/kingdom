...
6. **Personal notes** (`<NAME>.md` / `NOTES.md` at workspace OR project root, whatever the user names them) — read for situational awareness; **NEVER paste verbatim** (R7), never quote in commits / PRs / chat
