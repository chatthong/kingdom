---
description: Re-ground as a worker lane — re-read the canonical kingdom rules + the worker role spec from .kingdom/.setting/ and print a grounding summary. The King injects this as a freshly-spawned worker's first message (R52); re-run any time you've drifted.
---
